...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext (options)
{
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TagToUser>().HasData(
            ...
            new TagToUser { TagId = new Guid("3786a26c-7236-4f89-95cc-554525aa8249"), UserId = new Guid("0afa834e-ce99-4613-ac2c-c5b90268bc16"), EntityId = new Guid("a8cec4d6-869e-4c8a-b699-8880e471fdee") },
